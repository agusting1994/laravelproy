...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Alumno</b>soft</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          {!!Form::open(array('url'=>'cursado/cambiarmateria', 'method'=>'POST', 'autocomplete'=>'off'))!!}
          {{Form::token()}}
            
              <i class="fa fa-certificate text-primary"></i> 
              @if (count(Auth::user()->Cursos) > 1)
              <select id="sel1" onchange="this.form.submit()" name="idmateria" selected="{{ Session::get('idmateria') }}">
                @foreach (Auth::user()->Cursos as $cur)
                @if( Session::get('idmateria') == $cur->id)
                <option value="{{$cur->id}}" selected="true" >{{ $cur->nombre }}</option>
                @else
   ...
   <i class="fa fa-exchange-alt text-info"></i> </a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="/cursado"><i class="fa fa-home"></i> <span>Inicio</span></a></li>
        
       @if (Session::get('cart') != null)
        <li class="treeview">
          <a href="#"><i class="fa fa-indent"></i> <span>Materias</span>
          ...
          <ul class="treeview-menu">
            ...
            @foreach (Session::get('cart') as $element)
               <li><a href="/cursado/materia/{{ $element->id }}"> {{ $element->nombre }}</a></li>
              @endforeach
