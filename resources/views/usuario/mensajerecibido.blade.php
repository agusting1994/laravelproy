...
<section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-block margin-bottom">Nuevo mensaje</a>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5>Remitente: Juan Gabriel Pérez
            ...
            <div class="box-footer">
              ...
              <button type="button" class="btn btn-default"><i class="fa fa-trash"></i> Eliminar</button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
