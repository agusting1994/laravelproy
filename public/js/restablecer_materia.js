$(document).ready(function(){
	$('#alert').hide();
	$(".restablecer-materia").click(function(e){
        ...
        bootbox.confirm({
        message: "¿Estás seguro que deseas recuperar la materia <strong class='text-sucess'>" + nombre + "</strong>?",
    buttons: {
        confirm: {
            label: 'Recuperar',
...
$.ajax(
        {
            url: "/admin/materias/reactivarmateriaeliminada/"+id,
            type: 'GET',
            dataType: "JSON",
            data: {
                "_method": 'GET',
